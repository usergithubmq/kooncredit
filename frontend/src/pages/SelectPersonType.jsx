    ...
    return (
        <div className="flex min-h-screen bg-white text-slate-900 font-sans">
            ...
            <main className="flex-1 ml-56">
                <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex flex-col items-center justify-center px-3 py-8">

                    {/* Header con logo */}
                    <div className="text-center mb-10 md:mb-16">
                        <div className="mb-4">
                            <h1 className="text-1xl md:text-2xl font-extrabold text-[#279a94] mb-2">
                                KOON <span className="text-[#0c516e]">FINANSEN</span>
                            </h1>
